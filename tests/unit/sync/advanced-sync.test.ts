  console.log                                                                                                                                                                                                  
    ❌ Failed to upload Test Emulator saves: Command failed                                                                                                                                                    

      at log (src/cli/commands/advanced-sync.ts:116:15)import { jest, describe, beforeAll, afterAll, expect, test, beforeEach } from '@jest/globals';
...
// Create a typed mock execAsync function for the tests
...
describe('Advanced Sync Command', () => {
  test('Should sync emulator saves for upload', async () => {
    // Simulate a successful rclone execution
